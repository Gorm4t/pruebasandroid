...
class MainActivity : AppCompatActivity() {
    val lugares = arrayOf("Tequila","Magdalena","Arenal","Guadalajara","Guzman","Sayula","Vallarta",
    "Amatitan","Zacoalco","Chetumal","San Jose", "Hostotipaquillo","Tala")

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_main)
        val txtView: TextView = findViewById(R.id.txtCiudad)
        ...
        listView.onItemClickListener = object:AdapterView.OnItemClickListener {
            override fun onItemClick(p0: AdapterView<*>?, p1: View?, p2: Int, p3:Long){
                ...
                txtView.setText("Ustes seleccionó: $item")
